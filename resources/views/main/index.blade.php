         ...
         <section id="rh_slider__home" class="rh_slider rh_slider_mod clearfix">
            ...
            <div class="flexslider loading">
               <ul class="slides">
				...
				<li>
                     <a class="slide" href="#"
                        style=" cursor: default; background: url('{{ URL::to('/').'/images/'.$slider_val->single_photo}}') 50% 50% no-repeat;
                        ...
                        <div class="rh_prop_card__meta_wrap">
                           <div class="rh_prop_card__meta">
                              ...
                              <div>
                                 ...
                                 <!-- <img src="php" alt="" /> -->
                                 <span class="figure"> {{$Products_val->Rooms}}  </span>
                              </div>
                           </div>
                           <!-- /.rh_prop_card__meta -->
                           <div class="rh_prop_card__meta">
                              ...
                              <div>
                                 ...
                                 <!-- <img src="php" alt="" /> -->
                                 <span class="figure"> {{$Products_val->bathroom}}
  </span>
                              </div>
                           </div>
                           <!-- /.rh_prop_card__meta -->
                           <div class="rh_prop_card__meta">
                              ...
                              <div>
                                 ...
                                 <!-- <img src="php" alt="" /> -->
                                 <span class="figure"> {{$Products_val->Area}}
  </span>
                                 <span class="label">
                              متر							</span>
                              </div>
          ...
          <section class="rh_section rh_section__cta rh_cta--featured diagonal-border">
            ...
            <div class="rh_cta__wrap">
               ...
               <div class="rh_cta__btns">
                  ...
                  <a href="{{ URL::to('/').'/Contact/' }}" class="rh_btn rh_btn--greyBG"> تواصل معنا </a>
               </div>
               <!-- /.rh_cta__btns -->
            </div>
            <!-- /.rh_cta__wrap -->
   ...
   @foreach($Products_32 as $Products_val)
         ...
         <section class="rh_section rh_section__cta rh_cta--contact">
            ...
            <div class="rh_cta__wrap">
               ...
               <!-- /.rh_cta__quote -->
               <div class="rh_cta__btns">
                  <a href="{{ URL::to('/').'/Contact/' }}" class="rh_btn rh_btn--blackBG">
               تواصل معنا 				</a>
                  <a href="{{ URL::to('/').'/About/' }}" class="rh_btn rh_btn--whiteBG">من نحن  	</a>
               </div>
               <!-- /.rh_cta__btns -->
            </div>
            <!-- /.rh_cta__wrap -->
